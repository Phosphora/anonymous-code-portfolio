  ...
  return (
    <main className='MonProfil'>
      ...
      <section className="titre">
        <div className="texte-titre">
          <h1>{texteMonProfil[langue].section1.titre}</h1>
        </div>
        <div className="dessin-profil">
          <img className="fade-in" src={dessinProfil} alt="Dessin de profil de Winnie Li"/>
        </div>
      </section>
      {/* SECTION 2 - Présentation de soi-même */}
      <section className="profil-section2">
        <div className="profil-section2-texte">
          <h2>{texteMonProfil[langue].section2.titre}</h2>
          <p>{texteMonProfil[langue].section2.p}</p>
        </div>
        <div className="profil-section2-image">
          <img src={imageProfilSection2} alt="Dessin d'une personne qui travaille dans un bureau"/>
        </div>
      </section>
